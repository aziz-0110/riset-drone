...
""" line 344 untuk grafik """

class View(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()
        self.header = ['Frame', 'Green', 'Yellow', 'Red']
        self.dataTabel = [{self.header[i]: ' ' for i in range(4)} for _ in range(7)] # penjelasannya ada di line 533
    ...
    def setupUi(self, Form):
        ...
        self.label_informasi_2.setMaximumSize(QtCore.QSize(400, 16777215))
        ...
        self.label_informasi_6.setMaximumSize(QtCore.QSize(400, 16777215))
        ...
        self.label_informasi_10.setMaximumSize(QtCore.QSize(400, 16777215))
        ...
        self.label_informasi_7.setMaximumSize(QtCore.QSize(400, 16777215))
        ...
        self.label_informasi_8.setMaximumSize(QtCore.QSize(400, 16777215))
    ...
    def update_image(self, frame, label):
        height, width, channel = frame.shape
        bytes_per_line = 3 * width

        # qimg_ori = QtGui.QImage(frame_ori.data, width, height, bytes_per_line, QtGui.QImage.Format_RGB888)
        # img_ori = QtGui.QPixmap.fromImage(qimg_ori)
        # self.label_ori.setPixmap(img_ori.scaled(self.label_ori.size()))
        # qimg_hsv = QtGui.QImage(hsv.data, width, height, bytes_per_line, QtGui.QImage.Format_RGB888)
    ...
    def setupTabel(self):
        ...
        data = [ {header[i]: ' ' for i in range(4)} for _ in range(7)]  # hasilnya sama dgn komentar diatas

        self.tableView.setData(self.dataTabel)
        # self.tableView.saveAll()

        self.tableView.verticalHeader().setVisible(False)

        self.tableView.setColumnWidth(0, 264)
        self.tableView.setColumnWidth(1, 264)
        self.tableView.setColumnWidth(2, 264)
        self.tableView.setColumnWidth(3, 264)
